...
- Key combinators:
  ...
  - resultOf/runResultOf: wrap blocks into Result.
...
Practical example paths:
- Result API surface: [Result.kt:1-258](file://j-store-common-core/src/main/kotlin/com/jstore/common/utils/Result.kt#L1-L258)
