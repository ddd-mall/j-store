...
## Core Components
- Quality Gate Script: Orchestrates governance checks, spec-dev contract tests, and Gradle regression tests.
...
The development workflow integrates local and CI processes:
...
Git->>Dev : Pre-push Spotless check
...
- Running quality gates:
  - Execute ./scripts/quality-gate.sh to run all checks.
