- Domain interfaces are defined in the domain module and implemented in the infrastructure module (e.g., FulfillmentOrderRepository vs FulfillmentOrderRepositoryImpl).
