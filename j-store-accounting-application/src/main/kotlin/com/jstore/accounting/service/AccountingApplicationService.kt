...
class AccountingApplicationService(
  ...
  override fun recordOrderPaid(cmd: RecordOrderPaidCMD): Result<JournalEntry, BusinessError> {
  ...
  override fun recordOrderCompleted(
    ...
    val entry =
        JournalEntryImpl(
            id = journalEntryRepository.nextId(),
            entryNo =
                journalEntryRepository.nextEntryNo(JournalEntryType.ORDER_COMPLETION_COMMISSION),
  ...
  override fun recordOrderRefundApproved(
