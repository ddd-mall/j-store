...
class JournalEntryPO(
    ...
    @Column(name = "entry_no", nullable = false, length = 64) var entryNo: String = "",
    ...
    @Column(name = "source_id", nullable = false, length = 128) var sourceId: String = "",
    ...
    @Column(name = "reversed_by") var reversedBy: Long? = null,
    @Column(name = "reversal_of") var reversalOf: Long? = null,
...
class JournalLinePO(
    @Id @Column(name = "id") var id: Long = 0,
    @Column(name = "account_id", nullable = false) var accountId: Long = 0,
    @Enumerated(EnumType.STRING)
    ...
    @Column(name = "memo", nullable = false, length = 256) var memo: String = "",
)
