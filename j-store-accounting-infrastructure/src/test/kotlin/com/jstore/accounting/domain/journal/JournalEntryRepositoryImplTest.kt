...
constructor(
    ...
    fun `journal entry saves and loads with lines`() {
        ...
        restored.sourceDocument shouldBe
            SourceDocument(SourceDocumentType.ORDER, "order-1", "OrderPaidEvent")
        ...
        restored.lines.first { it.side == EntrySide.CREDIT }.accountId shouldBe
    ...
    fun `balance query only summarizes posted entries`() {
        ...
        val balances =
            repository.summarizeBalance(AccountingBalanceQuery(accountId = LedgerAccountId(1010)))
