...
CREATE TABLE IF NOT EXISTS outbox_entry (
    ...
    merchant_scope_id VARCHAR(128),
    deployment_scope_id VARCHAR(128),
...
ALTER TABLE trades ADD COLUMN IF NOT EXISTS checkout_source_digest varchar(128) NOT NULL DEFAULT 'DIRECT';
