 ...
 *
 * For any valid CountryCode that is NOT "CN", calling getByCode on a
 * GeoAddressServiceProxy with only ChinaAddressProvider registered
 * returns Failure with error code `Address.Country.Unsupported`.
 *
 * **Validates: Requirements 2.6, 6.4**
 */
class GeoAddressServiceProxyPropertyTest : FunSpec({
    ...
    test("Property 7: unsupported country code returns Failure with Address.Country.Unsupported") {
        // Feature: geo-address-i18n, Property 7: 不支持的国家编码错误
