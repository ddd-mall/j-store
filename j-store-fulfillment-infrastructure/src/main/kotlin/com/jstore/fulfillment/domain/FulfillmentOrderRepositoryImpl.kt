...
class FulfillmentOrderRepositoryImpl(
    private val jpaRepository: FulfillmentOrderPOJpaRepository,
) : FulfillmentOrderRepository {
    override fun save(entity: FulfillmentOrder): FulfillmentOrder = toDomain(jpaRepository.save(toPO(entity)))
    ...
    private fun toPO(fulfillment: FulfillmentOrder) = FulfillmentOrderPO(
    ...
    private fun toDomain(po: FulfillmentOrderPO): FulfillmentOrder = FulfillmentOrderImpl(
