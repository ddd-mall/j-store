...
object FulfillmentErrors {
    ...
    val SHIPPING_REFERENCE_INVALID = BusinessError("承运商或运单号无效", "Fulfillment.ShippingReference.Invalid", 400)
    val SHIPPING_REFERENCE_CONFLICT = BusinessError("履约单已关联其他运单", "Fulfillment.ShippingReference.Conflict", 409)
}
