  ...
  internal object Converter {
    ...
    fun toDomain(po: SpuSnapshotPO): SpuSnapshot {
      ...
      return SpuSnapshot(
          ...
          categoryIds = JsonUtils.deserialize<List<Long>>(po.categoryIds).map(::CategoryId).toSet(),
          localizedNames = po.localizedNames?.let { LocalizedText(JsonUtils.deserialize(it)) },
          localizedDescriptions =
