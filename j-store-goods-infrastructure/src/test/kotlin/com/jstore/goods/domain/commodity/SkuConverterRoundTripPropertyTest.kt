 ...
 *
 * For any 有效的 SKU 领域对象（包含任意 merchantCode 和 barcode 值，含 null），
 * 经过 Converter.toSkuPO 转换为 SkuPO 再经过 Converter.toDomainSku 转换回领域对象，
 * 结果应与原始对象在所有字段上等价（包括 merchantCode 和 barcode）。
 *
 * **Validates: Requirements 8.5, 9.5**
 */
class SkuConverterRoundTripPropertyTest : FunSpec({
    ...
    test("toSkuPO then toDomainSku should preserve all fields including merchantCode and barcode") {
