 ...
 *
 * For any 有效的 Spu（sourceSpuId 为 null 或非 null），经过 Converter.toPO 转换为 SpuPO， 再经过 Converter.toDomain
 * 转换回 Spu 后，sourceSpuId 应与原始值相等 （null 对 null，非 null 对非 null 且 value 相等）。
 *
