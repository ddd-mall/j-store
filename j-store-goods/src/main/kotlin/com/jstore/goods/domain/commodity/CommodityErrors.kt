...
object CommodityErrors {
    ...
    val SNAPSHOT_SPU_MUST_BE_ON_SALE =
        BusinessError("只有在售商品才能创建快照", "Goods.SnapshotSpuMustBeOnSale", 400)
    ...
    val ON_SALE_DIRECT_EDIT_REJECTED =
        BusinessError("在售商品不允许直接编辑，请通过草稿流程修改", "Goods.Draft.OnSaleDirectEditRejected", 400)
    val NOT_A_DRAFT_COPY = BusinessError("该商品不是草稿副本", "Goods.Draft.NotADraftCopy", 400)
    val ONLY_ON_SALE_NEEDS_DRAFT =
        BusinessError("只有在售商品需要通过草稿编辑", "Goods.Draft.OnlyOnSaleNeedsDraft", 400)
