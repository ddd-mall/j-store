 ...
 *
 * For any 有效的 ON_SALE 状态 SPU（包含任意 name、description、SKU 列表和 version），
 * 通过 SpuFactory.createDraftCopy 创建的草稿副本应满足：
 * 草稿的 name 等于源商品的 name，草稿的 description 等于源商品的 description，
 * 草稿的 SKU 列表与源商品的 SKU 列表内容一致，草稿的 version 等于源商品的 version，
 * 草稿的 status 为 DRAFT，草稿的 sourceSpuId 等于源商品的 id，
 * 草稿的 id 不等于源商品的 id。
 *
 * **Validates: Requirements 2.2, 2.3**
 */
class CreateDraftCopyDataIntegrityPropertyTest : FunSpec({
    ...
    val onSaleSpuArb: Arb<SpuImpl> = Arb.bind(
        Arb.long(1L..Long.MAX_VALUE),
        Arb.string(1..50),
        Arb.string(0..100),
        Arb.long(1L..10000L),
