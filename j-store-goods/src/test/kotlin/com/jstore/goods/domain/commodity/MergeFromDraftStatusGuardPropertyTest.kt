 ...
 * 调用 mergeFromDraft 应返回 Failure，且 SPU 的所有字段保持不变。
 *
 * **Validates: Requirements 9.5**
 */
class MergeFromDraftStatusGuardPropertyTest : FunSpec({
    ...
    test("mergeFromDraft should return Failure for non-ON_SALE SPU and leave all fields unchanged") {
