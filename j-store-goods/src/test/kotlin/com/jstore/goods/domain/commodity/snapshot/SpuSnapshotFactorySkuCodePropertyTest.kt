 ...
 *
 * For any SPU 及其包含的 SKU 列表（SKU 具有任意 merchantCode 和 barcode 值，含 null），
 * 通过 SpuSnapshotFactory.createSnapshot 创建快照后，每个 SkuSnapshot 的 merchantCode
 * 和 barcode 应与对应 SKU 的值完全一致。
 *
 * **Validates: Requirements 10.3, 10.4**
 */
class SpuSnapshotFactorySkuCodePropertyTest : FunSpec({
    ...
    val skuListArb: Arb<List<Sku>> = Arb.list(Arb.bind(
