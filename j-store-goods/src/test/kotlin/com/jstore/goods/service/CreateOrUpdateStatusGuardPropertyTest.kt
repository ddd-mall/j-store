 ...
 *
 * For any SPU 和任意有效的 CommodityCreateCmd，当 SPU 状态为 ON_SALE 时，
 * CommodityService.createOrUpdate 应返回 Failure（ON_SALE_DIRECT_EDIT_REJECTED）；
 * 当 SPU 状态为 DRAFT 或 OFF_SALE 时，应正常执行更新。
 *
 * **Validates: Requirements 5.1, 5.2**
 */
class CreateOrUpdateStatusGuardPropertyTest : FunSpec({
    ...
    val cmdArb: Arb<CommodityCreateCmd> = Arb.bind(
    ...
    val editableStatusArb: Arb<CommodityStatus> = Arb.of(
