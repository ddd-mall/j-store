 ...
 *
 * For any 合法的 ShippingInfo（含随机 consigneeName、ContractInfo、I18nGeoAddress、detailAddress）， 通过
 * Converter 转换为 RecipientInfoPO 再转换回 ShippingInfo，应产生与原始对象在所有字段上等价的结果。
 *
