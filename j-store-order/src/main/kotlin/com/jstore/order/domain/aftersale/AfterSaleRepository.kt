...
interface AfterSaleRepository : Repository<AfterSaleId, AfterSale> {
    fun createWithAllocation(afterSale: AfterSale, ceilings: List<RefundCapacityCeiling>, receipt: AfterSaleCommandReceipt): Result<AfterSale, BusinessError>
    fun findByOrderId(orderId: OrderId): List<AfterSale>
    fun saveDecision(afterSale: AfterSale, allocationAction: AllocationAction, receipt: AfterSaleCommandReceipt): Result<AfterSale, BusinessError>
