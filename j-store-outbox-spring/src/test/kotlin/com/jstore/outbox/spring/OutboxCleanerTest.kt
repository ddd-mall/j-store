...
class OutboxCleanerTest :
    FunSpec({
      test("cleanup drains multiple batches until a partial batch is returned") {
        ...
        val diffSeconds = kotlin.math.abs(capturedBefore.epochSecond - expectedCutoff.epochSecond)
      ...
      test("cleanup advances consumption details and inactive stream positions") {
        ...
        whenever(retentionRepository.deleteConsumptionsBefore(any(), eq(500))).thenReturn(500, 1)
