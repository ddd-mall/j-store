...
class PaymentApplicationService(
  ...
  override fun capture(
    ...
    val payment =
        repository.findByOrderId(command.orderId) ?: return Failure(PaymentErrors.ORDER_NOT_FOUND)
    val changed =
        payment.capture(
  ...
  override fun requestRefund(
    ...
    val payment =
        repository.findByOrderId(request.orderId) ?: return Failure(PaymentErrors.ORDER_NOT_FOUND)
    payment.refunds
