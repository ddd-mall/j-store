    ...
    return try {
      val profile =
          restClient
              ...
              ?: throw UserProfileDependencyException("User profile service returned an empty body")
      if (profile.userId != accountId) {
        throw UserProfileDependencyException("User profile service returned a mismatched user id")
      }
      profile
